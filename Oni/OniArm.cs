...
public class OniArm : PartsBehaviour
{
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        ...
        if (damaged < 0)
        {
            ...
            if (a != null)
            {
                a.AddForce(new Vector2(0, -attackKnock));
            }
        }
        ...
        if (damaged < 0)
        {
            ...
            if (a != null)
            {
                a.AddForce(new Vector2(0, -skillKnock));
            }
        }
    }
